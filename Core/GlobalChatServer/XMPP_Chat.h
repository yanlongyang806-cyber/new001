...
void XMPPChat_NotifyGuildOffline(SA_PARAM_NN_VALID ChatGuild *guild, SA_PARAM_NN_VALID ChatUser *user, bool bIsOfficer);
...
void XMPPChat_Logout(SA_PARAM_NN_VALID ChatUser *user, XmppClientState *state);
