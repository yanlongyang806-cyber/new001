...
void XMPPChat_InitChannelInfoData(SA_PARAM_NN_VALID XMPP_ChannelInfoData *data, int eDomain, SA_PARAM_NN_STR const char *room, const char *name);
...
void XMPPChatRoom_NotifyLeaveSingle (XmppClientState *state, SA_PARAM_NN_VALID ChatUser *user, int eDomain, const char *room, void *data);
...
#define XMPPChat_GetXMPPChannelInfo(node, desc, data, domain) XMPPChat_GetXMPPChannelInfoEx(node, desc, data, domain, false)
