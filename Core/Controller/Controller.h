...
typedef struct ServerTypeInfo
{
	...
	char *pMemLeakTracking_AlertKeyPrefix;
	...
	char *pOneMachineSpecifiedInShardSetupFile; NO_AST //for alerting purposes, a single machine that was specified in the shard setup file
} ServerTypeInfo;
