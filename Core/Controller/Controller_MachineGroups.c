...
void LazyLoadSharedGroupsFile(void)
{
	...
	if (!sGroupsFromSharedFileByName)
	{
		...
		sGroupsFromSharedFileByName = stashTableCreateWithStringKeys(16, StashDeepCopyKeys_NeverRelease);
...
void ControllerMachineGroups_AddAvailableMachineName(char *pName, U32 iPublicIP, U32 iPrivateIP)
{
	...
	{
		sAvailableMachinesByName = stashTableCreateWithStringKeys(16, StashDeepCopyKeys_NeverRelease);
	}
