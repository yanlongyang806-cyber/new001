...
typedef enum NotifySettingFlags
{
	...
	kNotifySettingFlags_DisableTutorial = (1 << 2),
		// If set, disable tutorial notify actions
	kNotifySettingFlags_DisableActionSound = (1 << 3),
		// If set, disables any sounds in the NotifyAction
	kNotifySettingFlags_DisableNotifySound = (1 << 4),
		// If set, disables any sounds included in the notification
} NotifySettingFlags;
...
void notify_NotifySendWithTagAndValue(	Entity *pEnt, 
										NotifyType eType, 
										SA_PARAM_OP_STR const char *pcDisplayString, 
										SA_PARAM_OP_STR const char *pcLogicalString, 
