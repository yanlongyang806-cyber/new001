...
typedef struct ControlScheme
{
	...
	bool bEnableFirstPersonCamera;		AST(PERSIST NO_TRANSACT USERFLAG(TOK_USEROPTIONBIT_1))
		// Enables a first person camera view
	...
	F32 fFlightMaxPitchAngle;		AST(PERSIST NO_TRANSACT USERFLAG(TOK_USEROPTIONBIT_1))
	// Value 0 - 90.0, clamped by fFlightPitchClampMin and fFlightPitchClamp  in CombatConfig
