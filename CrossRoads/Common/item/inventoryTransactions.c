...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Pplayer.Eaplayernumericthresholds, .Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Pscpdata.Erscp, .pInventoryV2.Peaowneduniqueitems, pInventoryV2.ppLiteBags[], .Psaved.Conowner.Containertype, .Hallegiance, .Hsuballegiance, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, pInventoryV2.ppInventoryBags[], .Pchar.Ilevelexp");
												...
												int iItemPowExpiredBag, int iItemPowExpiredSlot, const ItemChangeReason *pReason, GameAccountDataExtract *pExtract)
{
	...
	pItem = CONTAINER_NOCONST(Item, invbag_RemoveItem(ATR_PASS_ARGS, pEnt, false, BagID, SlotIdx, Count, false, pReason, pExtract));
	if (ISNULL(pItem))
	{
		return TRANSACTION_OUTCOME_FAILURE;
	}
...
enumTransactionOutcome inv_guild_tr_RemoveItem(ATR_ARGS, NOCONST(Guild)* pGuild, NOCONST(Entity) *pGuildBank, int BagID, int SlotIdx, int Count, ItemChangeReason *pReason)
{
	...
	pItem = inv_bag_trh_RemoveItem(ATR_PASS_ARGS, NULL, false, pBag, SlotIdx, Count, true, pReason);
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Pplayer.Eaplayernumericthresholds, .Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Pscpdata.Erscp, .pInventoryV2.Peaowneduniqueitems, pInventoryV2.ppLiteBags[], .Psaved.Conowner.Containerid, .Hallegiance, .Hsuballegiance, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containertype, pInventoryV2.ppInventoryBags[], .Pchar.Ilevelexp");
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Pplayer.Eaplayernumericthresholds, .Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Pscpdata.Erscp, .pInventoryV2.Peaowneduniqueitems, pInventoryV2.ppLiteBags, .Psaved.Conowner.Containertype, .pInventoryV2.Ppinventorybags, .Hallegiance, .Hsuballegiance, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Pchar.Ilevelexp");
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .pInventoryV2.ppInventoryBags[], .Psaved.Savedname, .Pplayer.Publicaccountname, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, pInventoryV2.ppLiteBags[], pInventoryV2.ppLiteBags[], .Pplayer.Eaplayernumericthresholds")
ATR_LOCKS(pGuild, ".Eamembers, .Uoldbanklogidx, .Eabanklog")
ATR_LOCKS(pGuildBank, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, pInventoryV2.ppLiteBags[], pInventoryV2.ppInventoryBags[], .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, .Hallegiance, .Hsuballegiance, .Pplayer.Eaplayernumericthresholds");
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Psaved.Ppallowedcritterpets, .Pplayer.Playertype, .Psaved.Ppownedcontainers, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Itemidmax, .Hallegiance, .Hsuballegiance, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppuppetmaster.Curtempid, .Pinventoryv2.Peaowneduniqueitems, pInventoryV2.ppInventoryBags[], pInventoryV2.ppLiteBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], .Pplayer.Eaplayernumericthresholds, .Pplayer.Eaastrrecentlyacquiredstickerbookitems");
...
bool inv_bag_trh_UpgradeItem(ATR_ARGS, ATH_ARG NOCONST(Entity)*pEnt, ATH_ARG NOCONST(InventoryBag) *pSrcBag, int iSrcSlot, U64 uSrcItemID, ATH_ARG NOCONST(InventoryBag) *pModBag, int iModSlotIdx, U64 uModItemID, ItemDef *pModDef, F32 fChance, int eSkillTypeUpgrade, const ItemChangeReason *pReason, GameAccountDataExtract *pExtract)
{
    ...
    {
        TRANSACTION_APPEND_LOG_FAILURE("Src item ID does not match.");
        return false;
    }
	...
	if(uModItemID)
	{
		...
		if (ISNULL(pModItemDef) || ISNULL(pModSlot->pItem)) {
			// There is no provision for an unspecified or empty source slot
            TRANSACTION_APPEND_LOG_FAILURE("Mod item not found.");
			return false;
		}

		pModItem = pModSlot->pItem;
        if ( pModItem->id != uModItemID )
        {
            TRANSACTION_APPEND_LOG_FAILURE("Mod item ID does not match.");
            return false;
        }
	}
	else if(pModDef)
	...
	if(fChance < 1.0)
	{
		...
		if(fRandValue > fChance)
		{
			...
			if(uModItemID)
			{
				inv_bag_trh_RemoveItem(ATR_PASS_ARGS,pEnt,false,pModBag,iModSlotIdx,1,true,pReason);
			}

			if(!pModifierDef || !pModifierDef->bNoLossOnFailure)
			{
				inv_bag_trh_RemoveItem(ATR_PASS_ARGS,pEnt,false,pSrcBag,iSrcSlot,1,true,pReason);
	...
	inv_bag_trh_RemoveItem(ATR_PASS_ARGS,pEnt,false,pSrcBag,iSrcSlot,iCount,true,pReason);
...
AUTO_TRANSACTION
	ATR_LOCKS(pEnt, ".Psaved.Ppuppetmaster.Curtype, .Psaved.Ppuppetmaster.Curtempid, .Psaved.Ppallowedcritterpets, .Itemidmax, .Psaved.Savedname, .Pplayer.Publicaccountname, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .pInventoryV2.Peaowneduniqueitems, .Pplayer.Playertype, .Psaved.Ppownedcontainers, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, pInventoryV2.ppInventoryBags[], pInventoryV2.ppLiteBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], .Pplayer.Eaastrrecentlyacquiredstickerbookitems")
...
AUTO_TRANS_HELPER
	ATR_LOCKS(pEntSrc, ".Psaved.Ppuppetmaster.Curtype, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Ppuppetmaster.Curtempid, .Psaved.Ppallowedcritterpets, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .pInventoryV2.Peaowneduniqueitems, .Pplayer.Playertype, .Psaved.Ppownedcontainers, .Itemidmax, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, pInventoryV2.ppInventoryBags[], pInventoryV2.ppLiteBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], .Pplayer.Eaastrrecentlyacquiredstickerbookitems")
...
AUTO_TRANSACTION
	...
	ATR_LOCKS(eaPets, ".Psaved.Ppuppetmaster.Curtempid, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Ppallowedcritterpets, .Pcritter.Petdef, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .pInventoryV2.Peaowneduniqueitems, .Pplayer.Playertype, .Psaved.Ppownedcontainers, .Itemidmax, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, pInventoryV2.ppInventoryBags[], pInventoryV2.ppLiteBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], .Pplayer.Eaastrrecentlyacquiredstickerbookitems")
	ATR_LOCKS(pGuild, ".Eamembers, .Uoldbanklogidx, .Eabanklog")
	ATR_LOCKS(pGuildBank, "pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], .pInventoryV2.ppLiteBags[], .pInventoryV2.ppLiteBags[]");
...
AUTO_TRANS_HELPER
ATR_LOCKS(pEnt, ".Psaved.Ppuppetmaster.Curtype, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Ppuppetmaster.Curtempid, .Psaved.Ppallowedcritterpets, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Psaved.Ppownedcontainers, .pInventoryV2.Peaowneduniqueitems, pInventoryV2.ppInventoryBags[], pInventoryV2.ppLiteBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], .Itemidmax, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Pplayer.Playertype, .Pplayer.Eaastrrecentlyacquiredstickerbookitems");
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Psaved.Ppuppetmaster.Curtype, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Ppuppetmaster.Curtempid, .Psaved.Ppallowedcritterpets, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Psaved.Ppownedcontainers, .pInventoryV2.Ppinventorybags, .Itemidmax, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .pInventoryV2.Peaowneduniqueitems, pInventoryV2.ppLiteBags[], .Pplayer.Playertype, .Pplayer.Eaastrrecentlyacquiredstickerbookitems");
...
int inv_ent_trh_BuildSwap(ATR_ARGS, ATH_ARG NOCONST(Entity)* pEnt, bool bSilent, ATH_ARG NOCONST(EntityBuild)* pBuild, const ItemChangeReason *pReason, GameAccountDataExtract *pExtract)
{
	...
	for(ii=eaSize(&pBuild->ppItems)-1; ii>=0; ii--)
	{
		...
		if(!pBuildItem->ulItemID)
		{
			...
			Item* pItem = invbag_RemoveItem(ATR_PASS_ARGS, pEnt, bSilent, pBuildItem->eBagID, pBuildItem->iSlot, -1, false, pReason, pExtract);
...
AUTO_TRANS_HELPER
ATR_LOCKS(pEnt, ".Pplayer.Eaplayernumericthresholds, .Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Pscpdata.Erscp, .pInventoryV2.Pplitebags, .pInventoryV2.Peaowneduniqueitems, .pInventoryV2.Ppinventorybags, .Hallegiance, .Hsuballegiance, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Pchar.Ilevelexp, .pPlayer.missionInfo.missions");
bool inv_ent_trh_RemoveMissionItems(ATR_ARGS, ATH_ARG NOCONST(Entity)* pEnt, const char* pMissionName, bool bIncludeGrantItems, const ItemChangeReason *pReason, GameAccountDataExtract *pExtract)
{
	...
	if ( ISNULL(pEnt->pPlayer))
		return false;
	if ( ISNULL(pEnt->pPlayer->missionInfo))
		return false;
	...
	for (iBag=0; iBag<NumBags; iBag++)
	{
		...
		bagiterator_trh_SetBagByID(ATR_PASS_ARGS, pEnt, bag->BagID, iter, pExtract);
		for(; !bagiterator_Stopped(iter); bagiterator_Next(iter))
		{
			...
			// is for UGC and that namespace becomes unplayable.
			{
				...
				if( !bFound && resExtractNameSpace_s( strItemDefName, SAFESTR( strItemNamespace ), NULL, 0 )) {
					...
					sprintf( ugcMissionName, "%s:Mission", strItemNamespace );
					if( !eaIndexedGetUsingString(&pEnt->pPlayer->missionInfo->missions, ugcMissionName)) {
						bFound = true;
					}
				}
			}
	...
	if( pMissionDef ) {
		...
		for (iBag=0; iBag<NumBags; iBag++)
		{
			...
			iter = bagiterator_Create();
			bagiterator_trh_SetLiteBagByID(ATR_PASS_ARGS, pEnt, bag->BagID, iter, pExtract);
			for(; !bagiterator_Stopped(iter); bagiterator_Next(iter))
			{
				ItemDef *pItemDef = bagiterator_GetDef(iter);
				bool bFound = false;
...
enumTransactionOutcome inv_tr_UnlockCostume( ATR_ARGS, NOCONST(Entity)* pEnt, int bSilent, U64 id, ItemChangeReason *pReason, GameAccountDataExtract *pExtract )
{
	...
	else
	{
		...
		if(pItemDef->bDeleteAfterUnlock)
		{
			...
			{
				Item *pRemItem = invbag_RemoveItem(ATR_PASS_ARGS, pEnt, true, pBag->BagID, iSlot, -1, false, pReason, pExtract);
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Pplayer.Eaplayernumericthresholds, .Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Pscpdata.Erscp, .pInventoryV2.Pplitebags, .pInventoryV2.Peaowneduniqueitems, .Psaved.Conowner.Containertype, .pInventoryV2.Ppinventorybags, .Hallegiance, .Hsuballegiance, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Pchar.Ilevelexp, .pPlayer.missionInfo.missions");
...
AUTO_TRANS_HELPER
	ATR_LOCKS(pTrueSrcEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Psaved.Ppownedcontainers, .Psaved.Ppuppetmaster, .Psaved.Ppalwayspropslots, .Psaved.Pipetidsremovedfixup, .Psaved.Conowner.Containertype, .pInventoryV2.Peaowneduniqueitems, .Psaved.Pppreferredpetids, .pInventoryV2.Ppinventorybags, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, pInventoryV2.ppLiteBags, .Pplayer.Eaplayernumericthresholds")
	ATR_LOCKS(pSrcEnt, ".Pplayer.Publicaccountname")
	ATR_LOCKS(pDstEnt, ".Pplayer.Skilltype, .Pplayer.Eskillspecialization, .Pchar.Hclass, .Pchar.Ppsecondarypaths, .Pchar.Hpath, .Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Ppuppetmaster, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pplayer.Publicaccountname, .Psaved.Ppownedcontainers, .Hallegiance, .Hsuballegiance, .Psaved.Ppallowedcritterpets, .pInventoryV2.Ppinventorybags, .pInventoryV2.Pplitebags, .Pplayer.Playertype, .Pchar.Ilevelexp, .pInventoryV2.Peaowneduniqueitems, .Itemidmax, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Pplayer.Eaplayernumericthresholds, .Pplayer.Eaastrrecentlyacquiredstickerbookitems")
	ATR_LOCKS(eaDstPets, ".Pcritter.Petdef, .pInventoryV2.Peaowneduniqueitems")
	ATR_LOCKS(eaOldPets, ".*")
	ATR_LOCKS(eaNewPets, ".*");
						  ...
						  GameAccountDataExtract *pDstExtract)
{
	...
	if(pTradeItemDef->eType == kItemType_Container && pTradeSlot->pItem->pSpecialProps)
	{
		...
		pItem = invbag_RemoveItem(ATR_PASS_ARGS, pTrueSrcEnt, false, pTradeSlot->SrcBagId, pTradeSlot->SrcSlot, pTradeSlot->count, false, pSrcReason, pExtract);
		...
		{
			iDstBagIdx = pItemDef ? inv_trh_GetBestBagForItemDef(pDstEnt, pItemDef, CONTAINER_NOCONST(Item, (pItem)), iPlayerCount, true, pDstExtract) : InvBagIDs_Inventory;
		}
...
AUTO_TRANS_HELPER
	ATR_LOCKS(pSrcEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pinventoryv2.Peaowneduniqueitems, .Pplayer.Publicaccountname, .Psaved.Ppownedcontainers, .Psaved.Ppuppetmaster, .Psaved.Ppalwayspropslots, .Psaved.Pipetidsremovedfixup, .Pinventoryv2.Pplitebags, .Psaved.Pppreferredpetids, .Pinventoryv2.Ppinventorybags, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Pplayer.Eaplayernumericthresholds")
	ATR_LOCKS(eaSrcPets, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Psaved.Conowner.Containertype, .Psaved.Ppownedcontainers, .Psaved.Ppuppetmaster, .Psaved.Ppalwayspropslots, .Psaved.Pipetidsremovedfixup, .Pinventoryv2.Peaowneduniqueitems, .Pinventoryv2.Pplitebags, .Psaved.Pppreferredpetids, .Pinventoryv2.Ppinventorybags, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Pplayer.Eaplayernumericthresholds")
...
typedef struct ItemSetCounter
{
	...
	ItemDef **ppGemMembers;
	ItemDef **ppGemMembersUnequipped;
} ItemSetCounter;
...
void entity_UpdateItemSetsCount(Entity *pEnt)
{
	if(g_bItemSets && pEnt && pEnt->pChar && pEnt->pInventoryV2)
	{
			...
			for (i = eaSize(&pBag->ppIndexedInventorySlots)-1; i >= 0; i--)
			{
				...
				if(pSlot->pItem)
				{
					...
					if (pSlot->pItem->pSpecialProps)
					{
						...
						{
							pItemDef = GET_REF(pSlot->pItem->pSpecialProps->ppItemGemSlots[iItemGemSlot]->hSlottedItem);
							if (pItemDef)
							{
								S32 iItemSet;
								for (iItemSet = eaSize(&pItemDef->ppItemSets)-1; iItemSet >= 0; iItemSet--)
								{
									...
									if (pItemDefSet)
									{
										...
										if(iSet>=0)
										{
											ANALYSIS_ASSUME(ppItemSetCounters && ppItemSetCounters[iSet]);
											if(bEquipped)
												eaPush(&ppItemSetCounters[iSet]->ppGemMembers,pItemDef);
											else
												eaPush(&ppItemSetCounters[iSet]->ppGemMembersUnequipped,pItemDef);
										}
										else
										{
											ItemSetCounter *pCounter = calloc(1,sizeof(ItemSetCounter));
											if(bEquipped)
												eaPush(&pCounter->ppGemMembers,pItemDef);
											else
												eaPush(&pCounter->ppGemMembersUnequipped,pItemDef);
											eaPush(&ppItemSets,pItemDefSet);
											eaPush(&ppItemSetCounters,pCounter);
										}
									}
		...
		for(i=eaSize(&ppItemSetCounters)-1; i>=0; i--)
		{
			...
			ItemDef *pItemSetDef = ppItemSets[i];
			int j,iCount = eaSize(&pCounter->ppMembers) + eaSize(&pCounter->ppGemMembers);

			if(pItemSetDef->bItemSetMembersUseCategories)
			{
				int k, l;

				// We intentionally do not cross-check the categories on regular items and gems. For most sane cases,
				// we do not mix item sets with gem sets. If you want mixed sets with gems and items that use category
				// culling, it can be implemented here
				for (j = 0; j < eaSize(&pCounter->ppMembers); j++)
				{
					ItemDef *pItemSetMemberDef = GET_REF(pCounter->ppMembers[j]->hItem);
					for (k = eaSize(&pCounter->ppMembers) - 1; k > j; k--)
					{
						ItemDef *pCheckDef = GET_REF(pCounter->ppMembers[k]->hItem);
						for (l = 0; l < eaiSize(&pItemSetMemberDef->peCategories); l++)
						{
							if (eaiFind(&pCheckDef->peCategories, pItemSetMemberDef->peCategories[l]) >= 0)
							{
								eaRemove(&pCounter->ppMembers, k);
								break;
							}
						}
					}
				}
				for (j = 0; j < eaSize(&pCounter->ppGemMembers); j++)
				{
					ItemDef *pItemSetMemberDef = pCounter->ppGemMembers[j];
					for (k = eaSize(&pCounter->ppGemMembers) - 1; k > j; k--)
					{
						ItemDef *pCheckDef = pCounter->ppGemMembers[k];
						for (l = 0; l < eaiSize(&pItemSetMemberDef->peCategories); l++)
						{
							if (eaiFind(&pCheckDef->peCategories, pItemSetMemberDef->peCategories[l]) >= 0)
							{
								eaRemove(&pCounter->ppGemMembers, k);
								break;
							}
						}
					}
				...
				iCount = eaSize(&pCounter->ppMembers) + eaSize(&pCounter->ppGemMembers);
			}

			if(pCounter->pItemSet)
				pCounter->pItemSet->uSetCount = (U8)iCount;
			for(j=eaSize(&pCounter->ppMembers)-1; j>=0; j--)
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pinventoryv2.Ppinventorybags[], .Pplayer.Skilltype, .Hallegiance, .Hsuballegiance, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, pInventoryV2.ppLiteBags[], .Pplayer.Eaplayernumericthresholds");
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .pInventoryV2.ppInventoryBags[], .Pplayer.Skilltype, .Pplayer.Eskillspecialization, .Hallegiance, .Hsuballegiance, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, pInventoryV2.ppLiteBags[], .Pplayer.Eaplayernumericthresholds");
										 ...
										 GameAccountDataExtract *pExtract)
{
	...
	for (i = 0; i < eaSize(&pExperimentData->ppEntry); i++)
	{
		...
		Item *pItem = invbag_RemoveItem(ATR_PASS_ARGS, pEnt, true, pExperimentEntry->SrcBagId, pExperimentEntry->SrcSlot, pExperimentEntry->count, false, pReason, pExtract);
			...
			if ( NONNULL(pSlot->pItem) )
			{
					...
					&& (eaSize(&pItemDef->ppCostumes) || (pSlot->pItem->pSpecialProps && GET_REF(pSlot->pItem->pSpecialProps->hCostumeRef))))
				{
					...
					if(pItemDef->bDeleteAfterUnlock)
					{
						...
						Item *pRemItem = (Item*)inv_bag_trh_RemoveItem(ATR_PASS_ARGS, pEnt, true, pBag, iSlot, pSlot->pItem->count, true,pReason);
						StructDestroy(parse_Item, pRemItem);
					}
				}
			}
...
AUTO_TRANSACTION
ATR_LOCKS(pEnt, ".Pplayer.Eaplayernumericthresholds, .Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Pscpdata.Erscp, .Psaved.Conowner.Containerid, pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], pInventoryV2.ppInventoryBags[], .Psaved.Conowner.Containertype, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Pinventoryv2.Peaowneduniqueitems, pInventoryV2.ppLiteBags[], pInventoryV2.ppLiteBags[]")
ATR_LOCKS(pGuildBank, "pInventoryV2.ppInventoryBags[]");
enumTransactionOutcome inv_bag_tr_ApplySort(ATR_ARGS, NOCONST(Entity)* pEnt, NOCONST(Entity) *pGuildBank, S32 eBagID, NON_CONTAINER S64EarrayWrapper* pSortedItemIDs, S32 bCombineStacks, const ItemChangeReason *pReason, GameAccountDataExtract* pExtract)
{
	...
	if (NONNULL(pBag) && !(invbag_trh_flags(pBag) & (InvBagFlag_EquipBag|InvBagFlag_WeaponBag|InvBagFlag_DeviceBag|InvBagFlag_ActiveWeaponBag)))
	{
								...
								if (NONNULL(pSlotCombine->pItem))
								{
									...
									if (pItemDefCombine == pItemDef)
									{
										...
										if (iFreeSpace > 0)
										{
											...
											if (inv_IsGuildBag(eBagID)) {
												pRemovedItem = CONTAINER_RECONST(Item, inv_bag_trh_RemoveItem(ATR_PASS_ARGS, NULL, true, pBag, i, iCount, true, pReason));
											} else {
												pRemovedItem = invbag_RemoveItem(ATR_PASS_ARGS, pEnt, true, eBagID, i, iCount, true, pReason, pExtract);
											}
		...
		for (i = 0; i < eaSize(&pSortedItemIDs->eaValues); i++)
		{
			...
			if (inv_bag_trh_FindItemByID(ATR_PASS_ARGS, pBag, uItemID, pBagIter))
			{
...
bool invtransaction_AddItem(Entity *pEnt, int BagID, int iSlot, Item *item, S32 eFlags, const ItemChangeReason *pReason, TransactionReturnCallback userFunc, void* userData)
{
	...
	{
		BagID = GetBestBagForItemDef(pEnt, pItemDef, item, item->count, true, pExtract);
	}
...
enumTransactionOutcome inv_ent_tr_RemoveItem(ATR_ARGS, NOCONST(Entity)* pEnt, int BagID, int SlotIdx, U64 uItemID, int Count, const ItemChangeReason *pReason, GameAccountDataExtract *pExtract)
{
	...
	if (bSuccess)
	{
		pItem = invbag_RemoveItem(ATR_PASS_ARGS, pEnt, false, BagID, SlotIdx, Count, false, pReason, pExtract);
		bSuccess = !!pItem;
	}
	if (!bSuccess)
	{
