...
typedef enum AuctionSortColumn
{
	...
	AuctionSort_Buyout,			// Sort by buyout (price per unit) first, name second
	AuctionSort_PriceDesc,				// Sort by price first, name second
	AuctionSort_NameDesc,				// Sort by name first, price second
	AuctionSort_BuyoutDesc,		// Sort by buyout (price per unit) first, name second
	...
	AuctionSort_Bid,			// Sort by current bid (price per unit) first, name second
	AuctionSort_BidDesc,		// Sort by current bid (price per unit) first, name second
