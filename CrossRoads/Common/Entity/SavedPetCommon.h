...
#define AlwaysPropSlot_FindByPetID(pEntity, uPetID, uPuppetID, eCategory) ((AlwaysPropSlot*)AlwaysPropSlot_trh_FindByPetID(CONTAINER_NOCONST(Entity, (pEntity)), uPetID, uPuppetID, eCategory))
...
#define AlwaysPropSlot_FindAllByPetID(pEntity, uPetID, uPuppetID, peaSlots) AlwaysPropSlot_trh_FindAllByPetID(CONTAINER_NOCONST(Entity, (pEntity)), uPetID, uPuppetID, peaSlots)
NOCONST(AlwaysPropSlot)* AlwaysPropSlot_trh_FindBySlotID(NOCONST(Entity)* pEntity, U32 uSlotID);
#define AlwaysPropSlot_FindBySlotID(pEntity, uSlotID) ((AlwaysPropSlot*)AlwaysPropSlot_trh_FindBySlotID(CONTAINER_NOCONST(Entity, (pEntity)), uSlotID))
