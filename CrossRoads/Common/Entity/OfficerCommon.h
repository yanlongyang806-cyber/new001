...
bool			Officer_CanTrain(int iPartitionIdx, SA_PARAM_NN_VALID Entity* pBuyer, SA_PARAM_NN_VALID Entity* pTrainer, U32 uiOfficerID, const char* pchOldNode, const char* pchNewNode, bool bCheckCost, bool bCheckNode, AllegianceDef *pAllegiance, PTNodeDef **pTrainNodeDef);
S32				Officer_GetTrainReturnValue(int iPartitionIdx, SA_PARAM_NN_VALID Entity* pBuyer, SA_PARAM_NN_VALID Entity* pTrainer, U32 uiOfficerID, const char* pchOldNode, const char* pchNewNode, bool bCheckCost, bool bCheckNode, AllegianceDef *pAllegiance, PTNodeDef **pTrainNodeDef);
