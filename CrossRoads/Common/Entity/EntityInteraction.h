...
AUTO_STRUCT;
typedef struct OverrideDisplayTextNode
{
	REF_TO(WorldInteractionNode) hNode;
	REF_TO(Message) hOverrideDisplayTextMsg;
}OverrideDisplayTextNode;
extern ParseTable parse_OverrideDisplayTextNode[];
#define TYPE_parse_OverrideDisplayTextNode OverrideDisplayTextNode
...
AUTO_STRUCT;
typedef struct InteractVolumeStatus
{
	char				*pchVolumeName;			AST(KEY)
		// The name of the volume
	bool				bInVolume;
		// Whether or not the player is in the volume
} InteractVolumeStatus;
...
typedef struct EntInteractStatus
{
	...
	OverrideDisplayTextNode** ppOverrideDisplayTextNodes;	AST(SELF_ONLY)
	...
	InteractVolumeStatus** ppInteractVolumeStatus;		AST(SELF_ONLY)
