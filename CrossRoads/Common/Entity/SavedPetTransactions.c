									 ...
									 int iSlotID, S32 ePropCategory, bool bMakeChanges)
{
	...
	if (uiPropEntID)
	{
		...
		{
			NOCONST(AlwaysPropSlot) **eaSlots = NULL;

			if (ePropCategory >= 0)
			{
				NOCONST(AlwaysPropSlot) *pPropSlot = AlwaysPropSlot_trh_FindByPetID(eMasterEntity, pSavedPet->pSaved->iPetID, uiPropEntID, ePropCategory);
				if (pPropSlot)
				{
					eaPush(&eaSlots, pPropSlot);
				}
			}
			else
			{
				AlwaysPropSlot_trh_FindAllByPetID(eMasterEntity, pSavedPet->pSaved->iPetID, uiPropEntID, &eaSlots);
			}

			if(iSlotID!=-1)
			{
				NOCONST(AlwaysPropSlot) *pPropSlot = AlwaysPropSlot_trh_FindBySlotID(eMasterEntity, iSlotID);
				if (pPropSlot)
				{
					eaPush(&eaSlots, pPropSlot);
				}
			...
			{
				S32 i;
				for (i = eaSize(&eaSlots)-1; i >= 0; i--)
				{
					NOCONST(AlwaysPropSlot)* pPropSlot = eaSlots[i];
...
AUTO_TRANSACTION
	ATR_LOCKS(pOwner, ".Pplayer.Eaplayernumericthresholds, .Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Pscpdata.Erscp, pInventoryV2.Peaowneduniqueitems, pInventoryV2.ppLiteBags, .Psaved.Ppallowedcritterpets, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Psaved.Ppownedcontainers, .pInventoryV2.Ppinventorybags, .Psaved.Conowner.Containertype, .Hallegiance, .Hsuballegiance, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Pchar.Ilevelexp, .Psaved.Ppuppetmaster.Pptemppuppets");
...
AUTO_TRANS_HELPER
	ATR_LOCKS(pOwner, ".Pplayer.Eaplayernumericthresholds, .Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Pscpdata.Erscp, .Psaved.Conowner.Containertype, .Pinventoryv2.Peaowneduniqueitems, .Psaved.Ppownedcontainers, .Pinventoryv2.Pplitebags, .Pplayer.Publicaccountname, .Hallegiance, .Hsuballegiance, .Psaved.Ppuppetmaster.Pppuppets, .Psaved.Ppallowedcritterpets, .Psaved.Ppalwayspropslots, .Psaved.Ppuppetmaster.Pppuppetrequests, .Pinventoryv2.Ppinventorybags, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid, .Psaved.Ppuppetmaster.Pptemppuppets")
	ATR_LOCKS(pEntSrc, ".Pplayer.Eaplayernumericthresholds, .Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Pscpdata.Erscp, .Pinventoryv2.Ppinventorybags, .Psaved.Conowner.Containertype, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Pinventoryv2.Peaowneduniqueitems, .Pinventoryv2.Pplitebags, .Psaved.Conowner.Containerid")
	ATR_LOCKS(pPet, ".Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Psaved.Ipetid, .Pchar, .Pcritter.Petdef, .Psaved.Savedname, .Pinventoryv2.Ppinventorybags, .Pinventoryv2.Peaowneduniqueitems, .Itemidmax, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppownedcontainers, .Psaved.Ppuppetmaster.Curtempid, .Psaved.Ppallowedcritterpets, .Pplayer.Playertype, pInventoryV2.ppLiteBags[], pPlayer.pPlayerAccountData.eaGamePermissionMaxValueNumerics[]");
					...
					const ItemChangeReason *pReason, GameAccountDataExtract *pExtract)
{
	...
	if (bFound)
	{
		...
		inv_trh_FixupAllItems(ATR_PASS_ARGS, pPet, pReason);
...
AUTO_TRANSACTION
ATR_LOCKS(pOwner, ".Pplayer.Eaplayernumericthresholds, .Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Pscpdata.Erscp, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Psaved.Ppownedcontainers, .pInventoryV2.Peaowneduniqueitems, .Pplayer.Publicaccountname, .Hallegiance, .Hsuballegiance, .Psaved.Ppuppetmaster.Pppuppets, .Psaved.Ppallowedcritterpets, .Psaved.Ppalwayspropslots, .Psaved.Ppuppetmaster.Pppuppetrequests, .pInventoryV2.Ppinventorybags, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, pInventoryV2.ppLiteBags, .Psaved.Ppuppetmaster.Pptemppuppets")
ATR_LOCKS(pEntSrc, ".Pplayer.Eaplayernumericthresholds, .Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Pscpdata.Erscp, .pInventoryV2.Ppinventorybags, .Psaved.Conowner.Containerid, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containertype, .pInventoryV2.Peaowneduniqueitems, pInventoryV2.ppLiteBags")
ATR_LOCKS(pPet, ".Psaved.Ppallowedcritterpets, .Pplayer.Playertype, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Psaved.Ipetid, .Pcritter.Petdef, .Pchar, .Pinventoryv2.Ppinventorybags, .Pinventoryv2.Peaowneduniqueitems, .Itemidmax, .Psaved.Savedname, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppownedcontainers, .Psaved.Ppuppetmaster.Curtempid, pInventoryV2.ppLiteBags[], pPlayer.pPlayerAccountData.eaGamePermissionMaxValueNumerics[]");
...
AUTO_TRANS_HELPER
ATR_LOCKS(pDstEnt, ".Pplayer.Eaplayernumericthresholds, .Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Pscpdata.Erscp, .Psaved.Conowner.Containerid, .Pplayer.Publicaccountname, .Psaved.Conowner.Containertype, .pInventoryV2.Peaowneduniqueitems, .Psaved.Ppownedcontainers, .Hallegiance, .Hsuballegiance, .Psaved.Ppuppetmaster.Pppuppets, .Psaved.Ppallowedcritterpets, .Psaved.Ppalwayspropslots, .Psaved.Ppuppetmaster.Pppuppetrequests, .pInventoryV2.Ppinventorybags, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, pInventoryV2.ppLiteBags, .Psaved.Ppuppetmaster.Pptemppuppets")
...
AUTO_TRANSACTION
	ATR_LOCKS(pOwner, ".Pplayer.Eaplayernumericthresholds, .Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Pscpdata.Erscp, .Pplayer.Nemesisinfo.Eanemesisstates, .Psaved.Conowner.Containertype, .Pinventoryv2.Peaowneduniqueitems, .Psaved.Ppownedcontainers, .Pinventoryv2.Pplitebags, .Pplayer.Publicaccountname, .Hallegiance, .Hsuballegiance, .Psaved.Ppuppetmaster.Pppuppets, .Psaved.Ppallowedcritterpets, .Psaved.Ppuppetmaster.Pptemppuppets, .Psaved.Ppalwayspropslots, .Psaved.Ppuppetmaster.Pppuppetrequests, .Pinventoryv2.Ppinventorybags, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Psaved.Uiindexbuild, .Psaved.Ppbuilds, .Psaved.Conowner.Containerid")
	ATR_LOCKS(pPet, ".Psaved.Ppallowedcritterpets, .Pplayer.Playertype, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Psaved.Ipetid, .Pcritter.Petdef, .Pchar, .Pinventoryv2.Ppinventorybags, .Pinventoryv2.Peaowneduniqueitems, .Itemidmax, .Psaved.Savedname, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppownedcontainers, .Psaved.Ppuppetmaster.Curtempid, pInventoryV2.ppLiteBags[], pPlayer.pPlayerAccountData.eaGamePermissionMaxValueNumerics[]");
	...
	if (uNewID)
	{
		...
		if (NONNULL(pNewPuppet))
		{
			...
			for (i = 0; i < iPuppetSlotCount; i++)
			{
				...
				bool bFound = (pSlot->iPuppetID == pNewPuppet->curID);

				// Check to see if this prop slot is pointing to an actual puppet
				if (!bFound && pSlot->iPuppetID)
				{
					NOCONST(PuppetEntity)* pPuppet = NULL;
					for (j = 0; j < eaSize(&pMaster->pSaved->pPuppetMaster->ppPuppets); j++)
					{
						pPuppet = pMaster->pSaved->pPuppetMaster->ppPuppets[j];
				...
				// If we don't have a puppet ID, or the puppet ID does not match another puppet we have,
				// then something went wrong, so assume that this puppet owns the prop slot.
				if (!bFound)
				{
					pSlot->iPuppetID = pNewPuppet->curID;
					pNewPuppet->ppSavedPropSlots[i]->iPuppetID = pNewPuppet->curID;
				}
...
bool Entity_SetPuppetStateOffline(ATH_ARG NOCONST(Entity) *pEnt, U32 uPuppetID)
{
	int i;
	NOCONST(PuppetEntity)* pOldPuppet = NULL;
...
AUTO_TRANSACTION
	ATR_LOCKS(pEnt, ".Psaved.Ppuppetmaster.Pppuppets");
enumTransactionOutcome trEntity_SetPuppetOffline(ATR_ARGS, NOCONST(Entity) *pEnt, U32 uPuppetID)
{
	if(NONNULL(pEnt->pSaved) && Entity_SetPuppetStateOffline(pEnt, uPuppetID))
	{
		TRANSACTION_RETURN_LOG_SUCCESS("SUCCESS %s Set %d as an offline puppet", pEnt->debugName, uPuppetID);
	}
	TRANSACTION_RETURN_LOG_FAILURE("FAILED %s could not set %d as an offline puppet", pEnt->debugName, uPuppetID);
}
