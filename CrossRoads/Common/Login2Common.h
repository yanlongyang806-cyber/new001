...
typedef struct Login2ShardStatus
{
    ...
    // What order the shard should be displayed in during shard selection.
    U32 displayOrder;
} Login2ShardStatus;
...
const char *GetExtraStringFromCharacterChoice(Login2CharacterChoice *characterChoice, int extraIndex);

const char *Login2_GetAllegianceFromCharacterChoice(Login2CharacterChoice *characterChoice);

const char *Login2_GetSubAllegianceFromCharacterChoice(Login2CharacterChoice *characterChoice);
