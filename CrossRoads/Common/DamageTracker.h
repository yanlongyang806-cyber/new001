...
typedef struct CombatLogClientFilter
{
	...
	// filters out CombatTrackerNet that are negative
	U32 bFilterNegativeMagnitude : 1;					AST(DEFAULT(1))

	// filters out CombatTrackerNet that are positive
	U32 bFilterPositiveMagnitude : 1;					AST(DEFAULT(1))
