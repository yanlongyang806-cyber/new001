...
// Flags corresponding to various chat permissions in GamePermissionsCommon.h
AUTO_ENUM;
typedef enum ChatGamePermissionInfoEnum
{
	CHAT_GAME_PERMISSION_INFO_NONE = 0,				// Normal email and chat rates and permissions
	CHAT_GAME_PERMISSION_INFO_RESTRICTED = BIT(0),	// This user is online with a character with lower chat and email rates
	CHAT_GAME_PERMISSION_INFO_TELL = BIT(1),		// Chat.Tell
	CHAT_GAME_PERMISSION_INFO_ZONE = BIT(2),		// Chat.Zone
	CHAT_GAME_PERMISSION_INFO_ZONE_RATELIMIT = BIT(3), // Chat.BypassZoneRL
...
AUTO_STRUCT;
typedef struct ChatRelayConfig
{
	U32 uZoneRateLimit; // number of messages...
	U32 uZoneRateLimitPeriod; // in X seconds
