...
typedef enum NotifyType
{
	...
	// Team Vote Kick
	kNotifyType_TeamVoteKickSucceed,
	kNotifyType_TeamVoteKickFail,
	...
	kNotifyType_ChatLFG,
	kNotifyType_ChatBlacklist,
	kNotifyType_ChatLinkForbiddenInChannel,
	...
	kNotifyType_SuperCritterPet_Upgraded,
	...
	kNotifyType_GroupProjectCollectionFeedback,
	...
	kNotifyType_ItemSalvageSuccess,
	kNotifyType_ItemSalvageFailure,

	// Mail
	kNotifyType_MailFailed,

	// Sticker Book
	kNotifyType_StickerBookItemGranted,
	kNotifyType_StickerBookSetComplete,

	// Addiction reminder
	kNotifyType_AddictionReminder,
