...
void power_AttachEnhancementsLocalApplyPower(int iPartitionIdx, SA_PARAM_NN_VALID PowerDef *pDef, SA_PARAM_OP_VALID Character *pchar, SA_PARAM_OP_VALID Power **ppEnhancementsLocal, SA_PARAM_NN_VALID Power ***pppAttachedOut);
...
// to be used in conjunction with power_GetEnhancementsForAttribModApplyPower to get the true character
Character* power_GetPowerEnhancementSource(SA_PARAM_OP_VALID Character *pModSource, SA_PARAM_OP_VALID Character *pModOwner);