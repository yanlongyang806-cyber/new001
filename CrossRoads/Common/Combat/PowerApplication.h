...
typedef struct PowerApplication
{
	...
	U32 bLevelAdjusting : 1;			NO_AST
		// True if AttribMods from this Application should adjust their damage
		//  to the level of the target Character because the source is a scary monster.
	
	U32 bTargetIsLevelAdjusting : 1;			NO_AST
		// True if  AttribMods from this Application should adjust their damage
		//  to the level of the target Character because the target is a scary monster.
