...
typedef struct CharacterAttribs
{
	...
	***************************************************************************/
	...
	F32 fBankRateFlying;						AST(SELF_ONLY)
	F32 fBankMaxAngleFlying;					AST(SELF_ONLY)
...
typedef enum AttribType
{
	...
	kAttribType_BankRateFlying = offsetof(CharacterAttribs,fBankRateFlying),
	kAttribType_BankMaxAngleFlying = offsetof(CharacterAttribs,fBankMaxAngleFlying),
