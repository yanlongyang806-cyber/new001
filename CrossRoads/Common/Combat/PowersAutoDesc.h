...
typedef struct AutoDescConfig
{
	...
	U32 bEntCreateLevelAdjustDown : 1;
		// if set, will adjust all entCreate levels down by 1.
		// used by STO since they show levels as 0 - 50 as opposed to what they actually are: 1 - 51 
