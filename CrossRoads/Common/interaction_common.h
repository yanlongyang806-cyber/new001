...
// There's no good reason for these to be autostructs.  I just want to use them in earrays, and free them later.
// Maybe there's something cool that could be done in the future.
AUTO_STRUCT;
...
AUTO_STRUCT;
typedef struct PlayerInteractedInfo
{
	InteractionInfo **  eaInfo;
	U32					uRetireTime;
} PlayerInteractedInfo;
extern ParseTable parse_PlayerInteractedInfo[];
#define TYPE_parse_PlayerInteractedInfo PlayerInteractedInfo
