...
S32 entity_ResetPowerIDsHelper(ATR_ARGS, ATH_ARG NOCONST(Entity)* pEnt, U32 uiSourceMask, GameAccountDataExtract *pExtract, bool bJustCount, PowerIDList *pResetIDs);
