...
bool trhMicroTrans_UnlockSpecies(ATR_ARGS, ATH_ARG NOCONST(Entity) *pEnt, ATH_ARG NOCONST(GameAccountData) *pAccountData, SpeciesDef *pSpecies)
{
	...
	if( ISNULL(pAccountData) || ISNULL(pSpecies) || ISNULL(pSpecies->pcUnlockCode))
		return(bUnlocked);
...
AUTO_TRANS_HELPER
ATR_LOCKS(pEnt, ".Pplayer.Skilltype, .Pplayer.Eskillspecialization, .Pchar.Hclass, .Pchar.Ppsecondarypaths, .Pchar.Hpath, .Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pplayer.Pplayeraccountdata.Iversion, .Psaved.Ppbuilds, .Psaved.Costumedata.Eaunlockedcostumerefs, .Hallegiance, .Hsuballegiance, .Pchar.Ilevelexp, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pplayer.Pplayeraccountdata.Eapendingkeys, .Psaved.Ppownedcontainers, .pInventoryV2.Peaowneduniqueitems, .Psaved.Ppuppetmaster.Pppuppets, .pInventoryV2.Ppinventorybags, .pInventoryV2.Pplitebags, .Pplayer.Playertype, .Itemidmax, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppuppetmaster.Curtempid, .Psaved.Ppallowedcritterpets, .Psaved.Uiindexbuild, .Pplayer.Eaplayernumericthresholds, .Pplayer.Eaastrrecentlyacquiredstickerbookitems")
	...
	case kMicroPart_Item:
		{
			...
			else
			{
				...
				else
				{
					...
					if(pItemDef->flags & kItemDefFlag_EquipOnPickup)
					{
						eBagID = inv_trh_GetBestBagForItemDef(pEnt, pItemDef, NULL, pPart->iCount, false, *ppExtract);
					}
					else if(pPart->bAddToBestBag)
					{
						eBagID = inv_trh_GetBestBagForItemDef(pEnt, pItemDef, NULL, pPart->iCount, true, *ppExtract);
					}
...
AUTO_TRANS_HELPER
ATR_LOCKS(pEnt, ".Pplayer.Skilltype, .Pplayer.Eskillspecialization, .Pchar.Hclass, .Pchar.Ppsecondarypaths, .Pchar.Hpath, .Psaved.pSCPdata.Isummonedscp, .Psaved.pSCPdata.Fcachedpetbonusxppct, .Psaved.pSCPdata.erSCP, .Pplayer.Pmicrotransinfo.Eaonetimepurchases, .Psaved.Ppbuilds, .Pplayer.Pplayeraccountdata.Iversion, .Hallegiance, .Hsuballegiance, .Psaved.Costumedata.Eaunlockedcostumerefs, .Pplayer.Pplayeraccountdata.Eapendingkeys, .Itemidmax, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, .Psaved.Ppownedcontainers, .pInventoryV2.Ppinventorybags, .Psaved.Ppuppetmaster.Pppuppets, .Psaved.Conowner.Containerid, .Psaved.Conowner.Containertype, .Pchar.Uipoweridmax, .Psaved.Ipetid, .Psaved.Ppuppetmaster.Curid, .Psaved.Ppuppetmaster.Curtype, .Psaved.Ppuppetmaster.Curtempid, .Psaved.Ppallowedcritterpets, .Psaved.Uiindexbuild, .Pplayer.Playertype, .pInventoryV2.Peaowneduniqueitems, .pInventoryV2.Pplitebags, .Pplayer.Eaplayernumericthresholds, .Pplayer.Eaastrrecentlyacquiredstickerbookitems")
ATR_LOCKS(eaPets, ".Pcritter.Petdef, .pInventoryV2.Peaowneduniqueitems, .Pcritter, .Pchar")
