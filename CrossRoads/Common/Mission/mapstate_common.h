...
typedef struct PlayerMapValues
{
	...
	U32 uTimeInitialized; AST(SERVER_ONLY)
		// Used by the queue aflk system to make sure only afk players are counted. If a player is there a short time no penalty
} PlayerMapValues;
