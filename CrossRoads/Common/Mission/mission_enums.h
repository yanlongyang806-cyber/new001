...
typedef enum MinimapWaypointType
{
	...
	MinimapWaypointType_Landmark,              // A landmark that is placed unscaled on the map
	MinimapWaypointType_AreaLandmark,          // A landmark that is scaled to a volume
...
typedef enum MissionDropTargetType
{
	...
	MissionDropTargetType_EncounterGroup_AllCombatantsDead,
