...
static void ClearMissionDefForTemplate(MissionDef* def)
{
	...
	COPY_HANDLE(detailStringMsg.hMessage, def->detailStringMsg.msg.hMessage);
#ifndef NO_EDITORS
	detailStringMsg.pEditorCopy = def->detailStringMsg.msg.pEditorCopy;
	def->detailStringMsg.msg.pEditorCopy = NULL;
#endif
	...
	COPY_HANDLE(def->detailStringMsg.msg.hMessage, detailStringMsg.hMessage);
	REMOVE_HANDLE(detailStringMsg.hMessage);
#ifndef NO_EDITORS
	def->detailStringMsg.msg.pEditorCopy = detailStringMsg.pEditorCopy;
#endif
