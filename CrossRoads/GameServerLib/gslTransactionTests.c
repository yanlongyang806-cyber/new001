...
AUTO_COMMAND;
void Test_SetRespectConversions(int iEntID, int iVal)
{
	AutoTrans_atr_SetRespectConversions(objCreateManagedReturnVal(TestEntTransCB, NULL), 
		GetAppGlobalType(), GLOBALTYPE_ENTITYPLAYER, iEntID, iVal);
}
...
AUTO_COMMAND;
void Test_AddRewardModifier(ACMD_DEFAULT("This is how to do a default, it could be an int instead") char *pKey)
{
