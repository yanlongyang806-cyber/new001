...
bool gbEnableItemEventLogging = false;
bool gbEnableItemTrackingLogging = true;
...
AUTO_CMD_INT(gbEnableItemTrackingLogging, EnableItemTrackingLogging) ACMD_AUTO_SETTING(GS_Logging, GAMESERVER);
