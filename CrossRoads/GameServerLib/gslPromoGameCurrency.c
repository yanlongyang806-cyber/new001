...
AUTO_TRANSACTION
ATR_LOCKS(playerEnt, ".Pplayer.Accountid, .Pplayer.Pplayeraccountdata.Eagamepermissionmaxvaluenumerics, .Pchar.Ilevelexp, .Psaved.Pscpdata.Isummonedscp, .Psaved.Pscpdata.Fcachedpetbonusxppct, .Psaved.Pscpdata.Erscp, .Hallegiance, .Hsuballegiance, pInventoryV2.ppLiteBags[], pInventoryV2.ppInventoryBags[], .Pplayer.Eaplayernumericthresholds")
