...
typedef struct LocalTeam
{
	...
	U32 bTimesCreatedTeam;	// the number of times we got a response from the TeamServer that a team was created for us. We assigned this team to hTeam.
	U32 bDissociated: 1;	// We were a valid team for a while, we were dissociated from our TeamServer Team, so don't need to do updates anymore.
...
void gslQueue_DoUpdateQueueMatch(U32 uPartitionID, QueueMatch *pMatchMembers);
