...
AUTO_COMMAND ACMD_NAME(mmSetBankRate) ACMD_LIST(gEntConCmdList) ACMD_NOTESTCLIENT;
void entConn_mmSetBankRate(Entity *e, F32 value)
{
	mrFlightSetBankRate(e->mm.mrFlight, value);
}

AUTO_COMMAND ACMD_NAME(mmSetMaxBankAngle) ACMD_LIST(gEntConCmdList) ACMD_NOTESTCLIENT;
void entConn_mmSetMaxBankAngle(Entity *e, F32 value)
{
	mrFlightSetMaxBankAngle(e->mm.mrFlight, value);
}
