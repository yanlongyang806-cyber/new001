...
void game_PartitionDestroyLate(MapPartition *pPart)
{
    ...
    coarseTimerAddInstance(NULL, "mapState_PartitionUnload");
	mapState_PartitionUnload(iPartitionIdx);
    coarseTimerStopInstance(NULL, "mapState_PartitionUnload");

    coarseTimerAddInstance(NULL, "eventtracker_PartitionUnload");
	eventtracker_PartitionUnload(iPartitionIdx);
    coarseTimerStopInstance(NULL, "eventtracker_PartitionUnload");
}
